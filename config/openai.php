...
return [
    ...
    */
    'project' => env('OPENAI_PROJECT', 'proj_kzlCy6bAKsIppEzPvnK7JRE8'),
    ...
    */
    ...
    'request_timeout' => env('OPENAI_REQUEST_TIMEOUT', 500),
    ...
    |--------------------------------------------------------------------------
    |
    | Recommended models for vision (multimodal):
    | - gpt-4o: Flagship model, most capable, supports vision
    | - gpt-4o-mini: Faster and cheaper, still supports vision
    |
    | Note: If using a custom endpoint (OPENAI_BASE_URL), ensure the provider
    | supports these model names.
    */

    'vision_model' => env('OPENAI_VISION_MODEL', 'gpt-4o'),
    'cards_model' => env('OPENAI_CARDS_MODEL', 'gpt-4o'),
